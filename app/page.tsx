...
export default function Dashboard() {
  ...
  const handleFullReportClick = () => {
    ...
    alert("Vollständiger Bericht wird angezeigt")
  }
  ...
  const handleDetailedScheduleClick = () => {
    ...
    alert("Detaillierter Zeitplan wird angezeigt")
  }

  const handleDetailedStatsClick = () => {
    setShowDetailedStats(true)
    // In a real application, this would open a modal or navigate to a detailed stats page
    alert("Detaillierte Nutzungsstatistiken werden angezeigt")
  }
      ...
      <header className="bg-[#0a9daa] dark:bg-gray-800 text-white p-8 pt-16 rounded-b-3xl">
        <div className="container mx-auto">
          ...
          <div className="absolute right-0 top-20 opacity-20 hidden lg:block">
            <div className="w-64 h-64 rounded-full bg-[#7dd0d8] dark:bg-teal-700"></div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-[#0a9daa] dark:bg-gray-800 rounded-xl p-6 text-white relative overflow-hidden">
            ...
            <div className="mt-8">
              <button
                className="bg-transparent border border-white text-white px-4 py-2 rounded-md hover:bg-white/20 flex items-center"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="bg-[#8cc63f] dark:bg-green-600 text-white text-xs px-2 py-1 rounded-full">2023-2025</div>
            </div>
              ...
              <Card className="border border-[#e0f0f2] bg-[#e8f6f8] dark:bg-gray-700 dark:border-gray-600">
                <CardContent className="p-4">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="bg-[#0a9daa] dark:bg-teal-600 text-white text-xs px-2 py-1 rounded-full">
                      Q2 2023
                    </div>
                  </div>
            ...
            <div className="mt-6 flex justify-end">
              <button
                className="bg-[#8cc63f] dark:bg-green-600 text-white px-4 py-2 rounded-md hover:bg-[#7ab535] dark:hover:bg-green-700"
